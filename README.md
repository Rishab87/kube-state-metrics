...
* `registry.k8s.io/kube-state-metrics/kube-state-metrics:v2.21.0` (arch: `amd64`, `arm`, `arm64`, `ppc64le` and `s390x`)
* [Multi-architecture images](https://explore.ggcr.dev/?image=registry.k8s.io%2Fkube-state-metrics%2Fkube-state-metrics:v2.21.0)
